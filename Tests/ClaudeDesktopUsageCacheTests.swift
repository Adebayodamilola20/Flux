...
final class ClaudeDesktopUsageCacheTests: XCTestCase {
    ...
    func testAMissingCacheDirectoryReadsAsNothing() {
        let missing = FileManager.default.temporaryDirectory
            .appendingPathComponent("devnotch-tests-absent-\(UUID().uuidString)")
    ...
    func testAnEntryForAnotherOrganizationIsIgnored() {
        ...
        // signed into one account while DevNotch may draw a ring per profile,
    ...
    private func makeCacheDirectory(_ files: [String: Data],
        ...
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("devnotch-desktop-cache-\(UUID().uuidString)",
                                    isDirectory: true)
        do {
