...
final class ClaudeOAuthProviderTests: XCTestCase {
    ...
    /// Claude Desktop is signed into one account; DevNotch draws a ring per
    ...
    func testAProfileWithNoRecordedOrganizationIsNotMatched() async throws {
        ...
        let home = FileManager.default.temporaryDirectory
            .appendingPathComponent("devnotch-nohome-\(UUID().uuidString)", isDirectory: true)
    ...
    func testNoDesktopCacheLeavesTheOldBehaviourIntact() async throws {
        ...
        let absent = FileManager.default.temporaryDirectory
            .appendingPathComponent("devnotch-absent-\(UUID().uuidString)", isDirectory: true)
        let provider = makeProvider(source: source, profile: desktopProfile(),
    ...
    private func desktopProfile(
        ...
        let home = FileManager.default.temporaryDirectory
            .appendingPathComponent("devnotch-home-\(UUID().uuidString)", isDirectory: true)
    ...
    private func makeCacheDirectory() -> URL {
        let directory = FileManager.default.temporaryDirectory
            .appendingPathComponent("devnotch-cache-\(UUID().uuidString)", isDirectory: true)
