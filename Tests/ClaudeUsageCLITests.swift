...
final class ClaudeUsageCLITests: XCTestCase {
    ...
    func testTheScratchDirectoryIsOneFixedPlace() throws {
        ...
        XCTAssertEqual(first.path, support.appendingPathComponent("DevNotch/usage-scratch").path)
    ...
    func testAScratchDirectoryThatCannotBeMadeThrows() throws {
        ...
        FileManager.default.createFile(atPath: support.appendingPathComponent("DevNotch").path,
                                       contents: Data())
