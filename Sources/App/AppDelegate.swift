...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    /// Quit any copy of DevNotch that was already running.
    ///
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        ...
        // `DEVNOTCH_DEMO=1` puts the design frame's three providers on screen
        // with its numbers, for screenshots and for eyeballing the layout.
        if ProcessInfo.processInfo.environment["DEVNOTCH_DEMO"] == "1" {
            ...
            // DEVNOTCH_DISCOVER=<url> loads that page in the signed-in WebView
            ...
            if let target = ProcessInfo.processInfo.environment["DEVNOTCH_DISCOVER"],
