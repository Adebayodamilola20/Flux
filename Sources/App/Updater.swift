...
final class Updater: NSObject, ObservableObject, SPUUpdaterDelegate {
    ...
    enum Outcome: Equatable {
        ...
        var message: String? {
            ...
            case .upToDate:      return L10n.t("DevNotch is up to date.")
            ...
            case .unreachable:
                ...
                return L10n.t("Couldn't reach the update server. DevNotch will try again on its own — nothing is wrong with this copy.")
