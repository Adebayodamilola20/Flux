...
private struct DevNotchAccentColorKey: EnvironmentKey {
    static let defaultValue = Color(nsColor: .controlAccentColor)
}

extension EnvironmentValues {
    var devnotchAccentColor: Color {
        get { self[DevNotchAccentColorKey.self] }
        set { self[DevNotchAccentColorKey.self] = newValue }
    }
}
