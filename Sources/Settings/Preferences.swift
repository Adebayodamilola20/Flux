...
final class Preferences: ObservableObject {
    ...
    /// The bundle identifier before the app was renamed to DevNotch.
    ///
    ...
    init(defaults: UserDefaults = .standard) {
        ...
        // Follow the Mac unless the user explicitly chooses a DevNotch colour.
    ...
    static func eraseAllData() {
        let bundleID = Bundle.main.bundleIdentifier ?? "com.vinz.devnotch"
    ...
    private func applyLaunchAtLogin() {
        do {
            ...
            launchAtLoginProblem = L10n.t("macOS refused this — try moving DevNotch to /Applications.")
