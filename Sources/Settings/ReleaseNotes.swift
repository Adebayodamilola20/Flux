            ...
            ReleaseNote(
                ...
                changes: [
                    ...
                    ReleaseNote.Change(
                        ...
                        detail: L10n.t("Every build now produces an app bundle you can run, so trying DevNotch no longer starts with a developer setup.")
                    ),
                ]
            ),
            ReleaseNote(
            ...
            ReleaseNote(
                ...
                changes: [
                    ReleaseNote.Change(
                        ...
                        detail: L10n.t("The figure came from a file Codex writes during a turn, so it was as old as the last time you used it — three days stale in one case. DevNotch now asks Codex itself, and matches its own panel.")
                    ),
                    ReleaseNote.Change(
            ...
            ReleaseNote(
                ...
                changes: [
                    ReleaseNote.Change(
                        ...
                        detail: L10n.t("Google will not answer DevNotch directly, so it asks Antigravity's own language server instead — the same place Antigravity's usage panel gets its figure.")
                    ),
                    ReleaseNote.Change(
            ...
            ReleaseNote(
                ...
                changes: [
                    ...
                    ReleaseNote.Change(
                        ...
                        detail: L10n.t("Each read from the tool already signed in on this Mac. DevNotch never asks for a password.")
                    ),
                    ReleaseNote.Change(
                        title: L10n.t("Choose where DevNotch appears"),
